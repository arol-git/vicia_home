...
PROMPT;
    ...
    public static function generateReply(string $userMessage, array $factualContext, array $recentMessages = []): string
    {
        ...
        if (!$apiKey) {
            ...
            return "Le moteur IA n'est pas encore configuré. Ajoute une clé dans AI_LLM_API_KEY pour obtenir des réponses détaillées.";
        }
    ...
    {
        if (empty($context)) {
            return "Je peux traiter les commandes et les informations de la maison, mais le moteur IA détaillé n'a pas répondu. Vérifie AI_LLM_API_KEY, le modèle configuré et la connexion internet du serveur.";
        }
