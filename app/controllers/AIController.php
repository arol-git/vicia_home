...
class AIController extends Controller
{
    ...
    /**
     * Endpoint de debug destiné à vérifier l'introspection AJAX lors
     * des tests: retourne des métadonnées sur la requête et le corps.
     */
    public function debug(): void
    {
        ...
        $info = [
            ...
            'headers' => $headers,
            'raw_body' => $raw,
            'post_params' => $this->request->all(),
        ];

        app_log('[AIController] Debug endpoint called: ' . substr(json_encode($info, JSON_UNESCAPED_UNICODE), 0, 2000));

        Response::json(['success' => true, 'debug' => $info]);
    }
