 ...
 * et de leur rôle de PLATEFORME (administrateur ou utilisateur). Les
 * rôles propres à chaque maison (owner/resident/technician) se gèrent
 * depuis HouseController::members().
 */
