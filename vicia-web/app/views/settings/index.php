...
<form id="settings-form">
    <div class="grid grid-cols-2">
        ...
        <div class="card">
            <div class="card__header"><div class="card__title">Notifications e-mail (relais SMTP partagé)</div></div>
            <div class="form-group">
            ...
            <div class="form-hint">Le jeton Telegram et l'e-mail d'alerte de chaque maison se configurent désormais depuis « Mes maisons » &rarr; modifier la maison.</div>
        </div>
    </div>
