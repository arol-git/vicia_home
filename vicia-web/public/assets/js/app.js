...
const ViciaApp = (() => {
    ...
    /**
     * Gère l'ouverture/fermeture du menu déroulant de sélection de
     * maison dans la barre latérale, ainsi que le changement de
     * maison courante (present sur toutes les pages authentifiées,
     * ce comportement vit ici plutôt que dans houses.js).
     */
